...
import { Loader2, CheckCircle2, XCircle, FileText, ArrowLeft, Trophy, Calendar, Clock, User, Menu } from "lucide-react";
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <header className="bg-white border-b border-slate-200 sticky top-0 z-30 px-4 sm:px-6 h-16 flex items-center justify-between shadow-sm">
                    <div className="flex items-center gap-4">
                        ...
                        <Link href="/dashboard" className="p-2 rounded-xl hover:bg-slate-100 text-slate-500 transition-colors hidden sm:block">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-indigo-50 text-indigo-700 rounded-lg border border-indigo-100">
                            <Trophy className="w-4 h-4" />
                            <span className="font-bold text-lg">{score}</span>
                            <span className="text-xs font-medium uppercase text-indigo-400 hidden sm:inline">Poin</span>
                        </div>
                    </div>
                </header>
                    ...
                    <div className="flex-1 overflow-y-auto p-4 sm:p-6 scroll-smooth">
                        <div className="max-w-3xl mx-auto space-y-6 pb-24">
                            ...
                            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                                <div className="p-4 sm:p-6 border-b border-slate-100 flex justify-between items-start bg-slate-50/50">
                                    <div className="flex items-center gap-3">
                                        ...
                                        {currentAnswer.is_correct ? (
                                            <span className="flex items-center gap-1 text-green-600 text-sm font-bold px-2 py-1 bg-green-50 rounded-md border border-green-200">
                                                <CheckCircle2 className="w-4 h-4" /> <span className="hidden sm:inline">Benar</span> (+{currentAnswer.score_earned})
                                            </span>
                                        ) : (
                                            <span className="flex items-center gap-1 text-red-600 text-sm font-bold px-2 py-1 bg-red-50 rounded-md border border-red-200">
                                                <XCircle className="w-4 h-4" /> <span className="hidden sm:inline">Salah</span> (0)
                                            </span>
                                        )}
                                    </div>
                                </div>
