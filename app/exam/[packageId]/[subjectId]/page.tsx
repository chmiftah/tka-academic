    ...
    return (
        <div className="flex h-screen bg-slate-50 font-sans selection:bg-indigo-100 overflow-hidden">
            ...
            <div className="flex-1 flex flex-col min-w-0">
                {/* --- Top Bar (Modernized) --- */}
                <header className="bg-white border-b border-slate-200 shadow-sm h-16 flex items-center justify-between px-4 sm:px-6 z-40 shrink-0">
                ...
                <main className="flex-1 flex flex-col lg:flex-row overflow-hidden relative">
                        ...
                        <div className="max-w-3xl mx-auto space-y-6 pb-24">
                            ...
                            <div className="flex items-center justify-between mt-8 gap-2">
                                <button
                                    ...
                                    className="
                                        flex items-center gap-1.5 px-3 py-2 sm:px-5 sm:py-2.5 rounded-lg border border-slate-200 text-slate-600 font-medium
                                        hover:bg-slate-50 hover:text-slate-900 disabled:opacity-50 disabled:cursor-not-allowed 
                                        transition-all active:scale-95 bg-white text-xs sm:text-base
                                    "
                                >
                                ...
                                <button
                                    onClick={toggleFlag}
                                    className={`
                                        flex items-center gap-1.5 px-3 py-2 sm:px-6 sm:py-2.5 rounded-lg border font-medium transition-all active:scale-95 text-xs sm:text-base
                                    ...
                                    `}
                                >
                                    <div className={`w-3 h-3.5 sm:w-3 sm:h-4 border-2 border-current ${flags.has(currentQuestion.id) ? 'bg-current' : ''}`}></div>
                                ...
                                {isLastQuestion ? (
                                    <button
                                        ...
                                        className="
                                            flex items-center gap-1.5 px-3 py-2 sm:px-6 sm:py-2.5 rounded-lg bg-blue-600 text-white font-bold 
                                            shadow-lg shadow-blue-200 hover:bg-blue-700 hover:shadow-blue-300
                                            active:scale-95 transition-all text-xs sm:text-base
                                        "
                                    >
                                        <span>Selesai</span>
                            ...
                            {/* Mobile Nav Toggle Button (Floating or inline logic could go here, but let's put a simplified trigger if needed. 
                                Actually, user requested "hide and show", implies a separate control. 
                                Let's add a button below the nav or integrated. 
                                Integrated: Add a "Grid" button to the control bar above)
                            */}
                            <div className="mt-4 lg:hidden">
                                <button
                                    onClick={() => setIsMobileNavOpen(!isMobileNavOpen)}
                                    className="w-full py-2 bg-indigo-50 text-indigo-600 rounded-lg text-sm font-bold border border-indigo-100 flex items-center justify-center gap-2"
                                >
                                    {isMobileNavOpen ? "Sembunyikan Daftar Soal" : "Lihat Nomor Soal"}
                                </button>
                            </div>
                    ...
                    <div className={`
                        w-full lg:w-80 bg-white border-t lg:border-t-0 lg:border-l border-slate-200 flex-col h-96 lg:h-full shrink-0
