...
export default function CreateQuestionPage() {
    ...
    const [options, setOptions] = useState<Option[]>([
        { id: "1", option_text: "", is_correct: false, score_value: 0 },
        { id: "2", option_text: "", is_correct: false, score_value: 0 },
        { id: "3", option_text: "", is_correct: false, score_value: 0 },
        { id: "4", option_text: "", is_correct: false, score_value: 0 },
    ]);
    ...
    useEffect(() => {
        const init = async () => {
            ...
            try {
                ...
                // Fetch Available Packages (related to this subject via package_subjects potentially? 
                // Or just show all packages with same level?
                // For simplicity, let's fetch all packages for now, or filter by level if possible)
                if (subjectData) {
    ...
    const addOption = () => {
        setOptions(prev => [
            ...prev,
            { id: Math.random().toString(), option_text: "", is_correct: false, score_value: 0 }
        ]);
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (validOptions.length > 0) {
                const optionsPayload = validOptions.map(o => ({
    ...
    if (isLoading) {
        return <div className="p-8 text-center text-slate-500">Memuat form...</div>;
    }
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6 pb-20">
            ...
            <div className="flex flex-col gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-slate-800">Buat Soal Baru</h1>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p className="text-xs text-slate-400 mt-1">Kosongkan jika soal ini belum masuk paket manapun.</p>
                        </div>
